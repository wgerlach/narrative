...
function Genotype_PhenotypeAPI(url) {
    ...
    {
	var resp = json_call_ajax_sync("Genotype_PhenotypeAPI.get_all_experiments", [kb_genome]);
//	var resp = json_call_sync("Genotype_PhenotypeAPI.get_all_experiments", [kb_genome]);
        return resp[0];
    }

    this.get_all_experiments_async = function(kb_genome, _callback, _error_callback)
    {
	json_call_ajax_async("Genotype_PhenotypeAPI.get_all_experiments", [kb_genome], 1, _callback, _error_callback)
    }
...
//	var resp = json_call_sync("Genotype_PhenotypeAPI.chromosome_position_from_variation_details", [variation_details]);
    ...
    {
	var resp = json_call_ajax_sync("Genotype_PhenotypeAPI.variations_to_genes", [arg_1, distance]);
//	var resp = json_call_sync("Genotype_PhenotypeAPI.variations_to_genes", [arg_1, distance]);
        return resp[0];
    }

    this.variations_to_genes_async = function(arg_1, distance, _callback, _error_callback)
    {
	json_call_ajax_async("Genotype_PhenotypeAPI.variations_to_genes", [arg_1, distance], 1, _callback, _error_callback)
    }

    this.find_common_snps = function(arg_1)
    {
	var resp = json_call_ajax_sync("Genotype_PhenotypeAPI.find_common_snps", [arg_1]);
//	var resp = json_call_sync("Genotype_PhenotypeAPI.find_common_snps", [arg_1]);
        return resp[0];
    }

    this.find_common_snps_async = function(arg_1, _callback, _error_callback)
    {
	json_call_ajax_async("Genotype_PhenotypeAPI.find_common_snps", [arg_1], 1, _callback, _error_callback)
    }
...
var clientSingleton = {
    PlantExpression : new PlantExpression('http://140.221.84.160:7063'),
    KBaseNetworks : new KBaseNetworks('http://140.221.92.181:7064/KBaseNetworksRPC/networks'),
    Ontology : new Ontology('http://127.0.0.1'),
    Genotype_PhenotypeAPI : new Genotype_PhenotypeAPI('http://140.221.84.160:7068'),
};
