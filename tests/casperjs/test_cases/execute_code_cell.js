...
casper.notebook_test(function () {
    ...
    this.test.done();
    /* IPthon.utils in our branch doesn't include these keyboard helpers
    this.echo('Trying to use press_ctrl_enter');
    ...
    this.echo('Waiting for press_ctrl_enter');
    this.wait_for_output(0);
    ...
    this.echo('Trying to use press_shift_enter');
    // do it again with the keyboard shortcut
    this.thenEvaluate(function () {
        var cell = IPython.notebook.get_cell(0);
    ...
    this.echo('Waiting for press_shift_enter');
    this.wait_for_output(0);
